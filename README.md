...
- **ISO Editor** (desktop Chrome/Edge/Brave/Opera) — **open both discs and edit them as
  ...
  - **Skills** — **EP cost, target (single ↔ AoE), power and element** for all **176**
...
Made by **Sparda**. · **v1.9.0** — see [Releases](https://github.com/TheSparda/Xenosaga-2-Editor/releases).
