...
# Enemy ids (record +0x52) partition the bestiary: 501+ field enemies, 561+
# bosses, 701+ E.S./special encounters. The rebalance tools use this to leave
# bosses alone by default.
BOSS_ID_MIN = 561
